                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            value="{{Auth::guard('admin')->user()->full_name}}" disabled>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="phone" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            value="{{Auth::guard('admin')->user()->phone}}" disabled>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('upload/'.$item->thumb)}}" alt=""
                                ...
                                <td class="button">
                                    ...
                                    <a style="color: red" href="{{url('admin/news/xoa/'.$item->id)}}"
                                        onclick="return myFunction();"> <i class="fa-sharp fa-solid fa-trash"></i> </a>
