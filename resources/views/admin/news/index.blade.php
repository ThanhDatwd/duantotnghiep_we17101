...
<form action="{{url('admin/news/xoa-nhieu')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="bg-light rounded h-100 p-4">
    <div class="text pt-2 pb-2 d-flex align-items-center justify-content-between">
      <h6 class="m-0">Quản lý tin tức</h6>
      <div class="adding">
      ...
      <table class="table table-hover align-middle">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img style="width:60px,height:50px" src="{{asset('upload/'.$item->thumb)}}" alt="" onerror="this.src='{{asset('upload/error.jpg')}}'">
            </td>
            ...
            <td class="">
              <a style="color: cadetblue" href="{{url('admin/news/capnhat/'.$item->id)}}"><i class="bi bi-pencil-square"></i></a>
              <a style="color: red" href="{{url('admin/news/xoa/'.$item->id)}}" onclick="return myFunction();"> <i class="bi bi-trash"></i> </a>
